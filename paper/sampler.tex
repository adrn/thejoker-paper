...
\altaffiltext{\flatiron}{Flatiron Institute,
                         Simons Foundation,
                         162 Fifth Avenue,
...
parameters.
% Aims
\resp{Here we create a custom Monte Carlo sampler for sparse or noisy
...
\samplername\ can therefore be used to produce proper samplings of multimodal
...
\url{https://github.com/adrn/thejoker} (\citealt{TheJoker:zenodo}).
The code used to run the experiments and generate the figures for this article
is available from \url{https://github.com/adrn/thejoker-paper}.
